...
The `geom_xx()` function specifies the type of plot we want to use to represent the data.
...
alpha ranges between 0 and 1, with lower values equating to more transparent dots.
