...
Please run the following code by clicking the <span style="color:green;">green arrow</span> just above the code chunk. When reading in the data, nothing will appear after you click the button. However, clicking the arrow ensures that your data are read in and can be used for the following activity. 
...
If you receive the error <span style="color:red;">Error: object 'bechdel' not found</span>, go back and read in your data above.
...
**NOTE** Question 4 could also be changed to have students edit the code into the correct format (from Coursera meeting: "Can have quiz questions with code blocks)
...
**NOTE** Question 5 could also be changed to have students edit the code into the correct format (from Coursera meeting: "Can have quiz questions with code blocks)

**Different 5** Could move up to question 1

Create side-by-side box plots of roi by clean_test where the boxes are colored by binary. Be sure to include appropriate labels. 
...
-- This AE also had a second section that had: 
      ...
      - Create side-by-side box plots of roi by clean_test where the 
      boxes are colored by binary.
      
      - What are those movies with very high returns on investment?
      
      - Expand on your plot from the previous step to zoom in on movies 
      with roi < ___ to get a better view of how the medians across 
