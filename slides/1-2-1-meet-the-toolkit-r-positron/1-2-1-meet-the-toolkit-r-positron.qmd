---
title: "Meet the toolkit: R and Positron"
format: revealjs
---
...
## ![](images/positron-logo.png){fig-align="center" width="427"}

::: incremental
-   Convenient interface for R called an **IDE** (integrated development environment), e.g. *"I write R code in the Positron IDE"*
...
![](images/positron-logo.png){fig-align="center" width="194"}
:::
...
-   As of August 2026, there are over 24,000 R packages available on **CRAN** (the Comprehensive R Archive Network)
...
![](images/positron-logo.png){width="194"}

## Tour recap: R and Positron

<br>

![](images/tour-r-positron.png){fig-align="center"}
