...
::: columns
::: {.column width="30%"}
![](images/ggplot2-part-of-tidyverse.png){fig-align="left" width="500"}
:::
...
# left here {.section-break}

# Coding out loud

## Step 1

.midi\[ \> **Start with the `penguins` data frame**\]
...
.midi\[ \> Start with the `penguins` data frame, \> **map bill depth to the x-axis**\]
...
.midi\[ \> Start with the `penguins` data frame, \> map bill depth to the x-axis \> **and map bill length to the y-axis.**\]
...
\] .panel\[.panel-name\[Narrative\] .pull-left-wide\[ .midi\[ Start with the `penguins` data frame, map bill depth to the x-axis and map bill length to the y-axis.
