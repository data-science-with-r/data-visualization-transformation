...
loan_amount_hist +
  geom_vline(
    xintercept = median(loans$loan_amount),
    color = "pink",
    linewidth = 2
  ) +
  labs(
...
loan_amount_hist +
  annotate(
    "segment",
    x = loan_amout_summary$q25,
    xend = loan_amout_summary$q75,
    y = 500,
    yend = 500,
    color = "pink",
    linewidth = 2
